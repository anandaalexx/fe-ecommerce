          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
            ...
            <div className="flex-1 space-y-4 text-left w-full border-b md:border-b-0 md:border-r border-gray-300 pb-4 md:pb-0 md:pr-8">
              <div className="flex flex-col md:flex-row items-start md:items-center">
                <label className="w-full md:w-1/4 text-sm text-gray-700">Username</label>
                <p className="text-sm text-gray-900">febrianulalal</p>
              </div>
              <div className="flex flex-col md:flex-row items-start md:items-center">
                <label className="w-full md:w-1/4 text-sm text-gray-700">Email</label>
                <p className="text-sm text-gray-900">
                  fe********@gmail.com <a href="#" className="text-[#D9B84E]">Ubah</a>
                </p>
              </div>
              <div className="flex flex-col md:flex-row items-start md:items-center">
                <label className="w-full md:w-1/4 text-sm text-gray-700">Password</label>
                <p className="text-sm text-gray-900">
                  ******** <a href="#" className="text-[#D9B84E]">Ubah</a>
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center">
              <img src={image} alt="Profile" className="w-24 h-24 rounded-full border mb-2" />
              <input type="file" accept="image/*" className="hidden" id="fileInput" onChange={handleImageChange} />
              <label htmlFor="fileInput" className="bg-[#D9B84E] text-white px-4 py-2 rounded text-sm cursor-pointer hover:bg-yellow-600">
                Pilih Gambar
              </label>
              <p className="text-xs text-gray-500 mt-1">Maks. 1 MB | .JPEG, .PNG</p>
            </div>
          </div>
